...
class DirContext:
    ...
    # constructor shortcut — populate all fields when path is provided
    ...
    def __post_init__(self, *args, **kwargs):
        ...
        self.package_dir = self._find_package_dir(self.project_dir or self.work_dir, self.package_key)
        ...
        self.pr_name = os.path.basename(self.project_dir) if self.is_package and self.project_dir else None
        self.pg_name = os.path.basename(self.package_dir) if self.is_package and self.package_dir else None
