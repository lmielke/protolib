# C:\Users\lars\python_venvs\packages\protolib\protopy\apis\server.pyw
...
# This server now acts as a dynamic control endpoint for the protopy package.
...
class ProtoControlHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def load_apis(cls, *args, **kwargs):
        ...
        for filename in os.listdir(apis_dir):
            ...
            try:
                module_path = f"protopy.apis.{api_name}"
