...
#Feature:  __'{{ context.name }}'__, Assembly Index: {{ context.assembly_ix }}
Hello everybody, these are the instructions for feature __'{{ context.name }}'__. 
...
# Description of feature {{ context.name }}
{% if context.t_name %}
